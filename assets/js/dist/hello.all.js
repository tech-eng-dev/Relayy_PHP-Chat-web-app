...
(function(hello) {
	...
	hello.init({
		...
		linkedin: {
			...
			get: {
				me: 'people/~:(picture-url,first-name,last-name,id,formatted-name,email-address,siteStandardProfileRequest,headline)',
					...
					if (p.data.id) {
						...
						if (p.data.picture && p.data.link) {
							data.content = {
								...
								'submitted-image-url': site_url + "assets/images/onlinkedIn.png"
							};
						}
					}
