...
defined('QUESTION_POST_SAMPLE')      OR define('QUESTION_POST_SAMPLE', "sample");
...
defined('TBL_USER_LINKEDIN_EMAIL')         OR define('TBL_USER_LINKEDIN_EMAIL',   'lemail');
...
defined('TBL_USER_BYADMIN')        OR define('TBL_USER_BYADMIN',  'byadmin');
...
defined('TBL_OPTION_FEEDALERT')            OR define('TBL_OPTION_FEEDALERT',      'feed_alert');
...
defined('TBL_BUSINESS_CHALLENGE')         OR define('TBL_BUSINESS_CHALLENGE',   'challenge');
...
defined('TBL_USER_INVITE_NO')            OR define('TBL_USER_INVITE_NO',      'no');
defined('TBL_USER_INVITE_WHOM')            OR define('TBL_USER_INVITE_WHOM',      'whom_id');
defined('TBL_USER_INVITE_GROUP')            OR define('TBL_USER_INVITE_GROUP',      'invite_group');
defined('TBL_USER_INVITE_ROLE')            OR define('TBL_USER_INVITE_ROLE',      'role');
defined('TBL_USER_INVITE_WHO')            OR define('TBL_USER_INVITE_WHO',      'who_id');
...
defined('TBL_FEED_GROUP')            OR define('TBL_FEED_GROUP',      'action_group');
...
defined('TBL_NAME_USER_INVITE')          OR define('TBL_NAME_USER_INVITE',     'tbl_user_invite');
