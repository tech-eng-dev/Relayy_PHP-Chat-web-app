...
class Mreview extends CI_Model {
    ...
    public function getReviews($receiverID){
        $query = $this->db->select('tbl_review.id as id, tbl_review.from_id as from_id, tbl_review.review as review, tbl_user.photo as photo, tbl_user.fname as fname, tbl_user.lname as lname')
