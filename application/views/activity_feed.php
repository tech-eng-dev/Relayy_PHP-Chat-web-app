...
<div class="container-widget">
	...
	<div class="row white_back content-title-bar">
		<h3 class="pull-left gray-text">ACTIVITY FEED</h3>
	</div>
	...
	<div class="row padding_30 feed_div">
		...
		foreach($feeds as $feed){ 
			...
			$index++;
			?>
		<div class="row feed_row padding_3 box-section" data-num="<?= $feed[TBL_FEED_NO] ?>">
			...
			<div class="col-md-8 col-xs-10 feed_info pull-left padding_xs">
				<div class="feed_text">
			...
			<div class="col-md-3 col-xs-12">
				<?php if($u_type == 1) { ?>
				<span class="pull-right padding_xs glyphicon glyphicon-trash gray-text" onclick="delete_feed(this, '<?= $feed[TBL_FEED_NO] ?>')"></span>
				<?php } ?>
				<div class="pull-right feed_time padding_xs gray-text" data-time="<?= $feed[TBL_FEED_TIME] ?>" style="text-align:right;">				
				</div>
			</div>
...
<script>
    ...
    function delete_feed(obj, num){
    	$.ajax({
	        url: site_url + 'Users/DeleteFeed',
	        data: {
	        	num: num
	        },
	        success: function(data) {
