...
function edit_funding(){
  ...
  function edit_group(n_moderator){
  ...
  function EditProfile(){
    location.href = site_url + 'profile/edit/' + currentUser_id ;
  }
  

</script>

<div class="white_back content-title-bar">
  <h3 class="pull-left gray-text">MY PROFILE</h3>
</div>
          ...
          <div class="row padding_xs">
                ...
                <div class="col-md-6 col-xs-12 col-text container-widget" style="line-height:22px;">
                  ...
                  <div class="row font-16">
                    ...
                    <div class="col-xs-9">
                      <a class="col-xs-10" target="_blank" href="<?= $public_url ?>"><p class="wrapword" id="my_link"><?= $public_url?$public_url:"-"?></p></a>
                    </div>
                  </div>
                </div>
        ...
        <div class="row div-item border1" style="margin-top:0px;">
            <div class="col-sm-6 col-xs-12">
              <div class="col-xs-12">
                ...
                <?php if($u_type == 4){ ?>
                  <h5 class="col-xs-2 gray-text glyphicon glyphicon-pencil" onclick="edit_group(<?= $n_moderator ?>)"></h5>
                <?php } else if($u_type != 1 && strlen($u_group) > 0){ ?>
                  <h5 class="col-xs-2 gray-text glyphicon glyphicon-pencil" onclick="LeaveGroup();"></h5>
                <?php } ?>
              </div>
              <div class="col-xs-12">
...
<!-- //====================  Profile Skills  //====================-->
    ...
    <div class="row">
      <div class="col-md-6 col-xs-12 border1 border2" id="section-seeking" style="padding:20px;">
          ...
          <div class="row">
            <h4 class="col-xs-10 nm gray-text"> <?php echo $u_type == 3?"CURRENTLY SEEKING:":" INTERESTED IN:" ?> </h4>
          ...
          <div class="row" id="interesting_Editfield" style="display:none;">
            <div class="col-sm-6 col-xs-12">
              <input type="text" class="border-style-xs radius-input" id="add_interesting" placeholder="Type your interesting" onkeypress="detect_interesting(event, this)" style="width:100%;">
            </div>
      ...
      <div class="col-md-6 col-xs-12 border1 border2" id="section-skill" style="padding:20px;">   
        ...
        <div class="row" id="skill_Editfield" style="display:none;">
          <div class="col-sm-6 col-xs-12">
          <input type="text" class="border-style-xs radius-input" id="add_skill" placeholder="Type your skill" onkeypress="detect_skill(event, this)" style="width:100%;">
          </div>
          <div class="col-sm-3 col-xs-6">
                ...
                <li class="padding_xs" id="<?= $review['id']?>">
                  <div class="row"> 
                    ...
                    <div class="col-sm-11 col-xs-10">
                      <a title="<?= $review['fname']." ".$review['lname'] ?>"><img class="avatar avatar_small pull-left" src="<?= strlen($review['photo'])>0?$review['photo']:asset_base_url().'/images/emp.jpg' ?>" ></a>
