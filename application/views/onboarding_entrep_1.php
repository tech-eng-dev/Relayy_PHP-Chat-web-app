    ...
    <body class="onboarding-content <?php if(isset($body_class)) echo $body_class; ?>">
   	<div class="onboarding-content onboarding-body">
		...
		<div class="onboarding-container container-widget">
			...
			<div class="row">
				<center><h5 class="gray-text">What are a few areas of business expertise in which we could help you? This will help us match you to experts.</h5></center>
			</div>
			<div class="row">
				<center>
					<div class="col-sm-9">
			...
			<div class="row">
				<center><h1><button class="btn" onclick="save_Interesting_in()">SAVE & CONTINUE</button></h1></center>
			</div>
			<div class="row">
		...
		<script>
			...
			function save_Interesting_in(){
				if(array_tags.length == 0) return;
				$.ajax({
		            url: site_url + "home/save_Interesting_in",
		            data: {
			...
			function skip_page(){
				$.ajax({
		            url: site_url + "home/switchTo_onboarding_entrep_2",
		            data: {
