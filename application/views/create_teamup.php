...
<div>
	...
	<div class="row">
		<h5><?= $name ?></h5>
		<h5><b>ADVISORS MATCHED IN TEAMUP:</b></h5>
	</div>
	...
	<div class="row Qinput">
		<div class="row desktop-visible-item">
			...
			<div class="col-md-6 col-xs-12 padding_xs">SELECT: <a onclick="selectAllWaiters()">ALL</a> | <a onclick="selectNone()">NONE</a> | <span id="selected_waiting"></span> SELECTED</div>
		...
		<div class="row mobile-visible-item">
			...
			<div class="col-md-6 col-xs-12 padding_xs"><center>SELECT: <a onclick="selectAllWaiters()">ALL</a> | <a onclick="selectNone()">NONE</a> | <span id="selected_waiting"></span> SELECTED</center></div>
			<div class="col-md-6 col-xs-12 padding_xs"><center><button type="button" class="ob" onclick="createTeamUp()">CREATE TEAMUP WITH SELECTED<div class="teamup-spinner teamup-create-spinner" style="display:none;"><i class="fa sm-button fa-spinner fa-spin"></i></div></button></center></div>
		</div>
	</div>
