...
<script type="text/javascript">
  ...
  console.log('running timer');
    ...
    function checkInviteGroup(){
      $.ajax({
        url: site_url + 'Invite/loadInviteGroupView',
        data: {
        },
        success: function(data) {
    ...
    function onDeclineGroupInvite(){
      $.ajax({
        url: site_url + 'Users/DeclineGroupInvite',
        data: {
    ...
    function onAcceptGroupInvite(){
      $.ajax({
        url: site_url + 'Users/AcceptGroupInvite',
        data: {
    ...
    <div id="dialogs-list">
        ...
        <?php 
            ...
            <ul class="sidebar-panel nav sidechatlist container-widget" style="margin:0;" >
              <button class="trans full-width full-height" onclick="gotoChat('<?= $dialog['did'] ?>')">
                    ...
                    <div class="col-xs-10" style="height:100%;">
                        <div class="container-widget" style="margin:0;">
                            <div class="row" style="height:18px;margin:10px 0px;overflow:hidden;">
                                <div class="col-xs-8">
                                    <p class="wrapword li-dialog-name" style="font-size:16px; color:#111;"><strong class="wrapword pull-left d_title" style="<?= $dialog['type'] == 0?'color:#4e4ef3':'' ?>"><?= $dialog['name']?></strong></p>
                                </div>
                            ...
                            <div class="row" style="height:20px;margin:0;overflow:hidden;">
                                <span class="list-group-item-text last-message font-13 gray-text pull-left"><?= $dialog['h_message']?></span>
                            </div>
                            <?php } ?>
...
<div class="content scrollbar" style="margin-left:300px;max-height:100vh;min-height:100vh;overflow-y:scroll;overflow-x:hidden;">
