...
<html>
   <head>
      ...
      <meta prefix="og: http://ogp.me/ns#" property="og:site_name" content="Relayy" />
      <meta prefix="og: http://ogp.me/ns#" property="og:title" content="Relayy" />
      <meta prefix="og: http://ogp.me/ns#" property="og:description" content="Web Chat Application" />
      <meta prefix="og: http://ogp.me/ns#" property="og:url" content="app.relayy.io/questions" />
      <meta prefix="og: http://ogp.me/ns#" property="og:image" content="<?= asset_base_url()?>/images/onlinkedIn.jpg" />
      <meta prefix="og: http://ogp.me/ns#" property="og:image:width" content="245" />
      <meta prefix="og: http://ogp.me/ns#" property="og:image:height" content="150" />
      <?php if(strpos(site_url(), 'app') === false) { ?>
    ...
    <body class="body" style="font-family:'proximanovar';min-height:100%;overflow-y:hidden;">
        <div id="top" class="clearfix" style="background:#FFF;">
              ...
              <ul class="dropdown-menu dropdown-menu-list pull-right">
                ...
                <?php } ?>
                <?php if($u_type == 1) { ?>
                  <li><a href="<?php echo site_url('users/challengers')?>">Top Entrepreneurs</a></li>
                <?php } ?>
                    ...
                    <div class="container-widget padding_xs scrollbar"  style="max-height:70vh;">
                      ...
                      <?php if(strlen($u_group)> 0){ ?>
                        <div class="row">
                          ...
                          <?php if(isset($my_group) && strlen($my_group)>1){ ?>
                      ...
                      <?php if(strlen($u_group) > 0){ ?>
                      <div class="row">
                        <button type="button" class="mytooltip pull-right submit-tooltip-button" onclick="">
                          ?
                          <span class="tooltiptext">
                            <h6 class="wtext">Submit to Group:</h6>
                            <p>Your question is privately matched to relevant advisors that are also members of your group. This is the most effective option at getting a match, and if needed, the question can later be matched to the broader Relayy advisory network.</p>
                            <h6 class="wtext">Submit to Relayy:</h6>
                            <p>Your question is privately matched to relevant advisors in the broader Relayy network. Only use this option if you don't want the question going to your group leaders or advisors.</p>
                          </span>
                        </button>
                      </div>
                      <?php } ?>
...
//left sidebar
        ...
        $("#dropdown-invite").click(function(e){
          ...
          var user_role = [];
          if(currentUser_type == 1) user_role.push("Admin");
          else if(currentUser_type == 2) user_role.push("Advisor");
          else if(currentUser_type == 3) user_role.push("Entrepreneur");
          else user_role.push("Moderator");
