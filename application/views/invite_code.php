...
<div class="profile-container">
	...
	<div class="container-widget white_back border1234 padding_sm" style="line-height:1.5;">
		<?php if($invite_code[TBL_INVITE_TYPE] == 1) { ?>
		...
		<?php } else { ?>
			...
			<div class="row">
				...
				<?php }else if(isset($invite_code[TBL_INVITE_CODE])){ ?>
					<?php if(strlen($group) > 0){ ?><h5 style="color:red;"><b>*Warning:</b> Only group moderators can invite members to your group. Your invite code can be used to invite new users, but they will not be attached to your group.</h5><?php } ?>
